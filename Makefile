...
version: copy
	@echo "# The content of this file is generated by the packaging" >  $(tmpdir)/$(pkg_dir)/lib/sequencer/.metainfo
	@echo "# process (either setup.py or Makefile)" >> $(tmpdir)/$(pkg_dir)/lib/sequencer/.metainfo
	@echo "# Do not change it manually." >> $(tmpdir)/$(pkg_dir)/lib/sequencer/.metainfo
